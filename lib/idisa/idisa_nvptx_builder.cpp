...
DEFINE_BUILDER_CACHE_NAME(IDISA_Neon_Builder, "NVPTX20_" + std::to_string(groupThreads), NativeBitBlockWidth())

unsigned IDISA_NVPTX20_Builder::getGroupThreads_impl() const { return groupThreads; }

Value *IDISA_NVPTX20_Builder::bitblock_any_impl(Value *val) {
...
Value *IDISA_NVPTX20_Builder::bitblock_mask_from_impl(Value *pos, const bool safe) {
...
Value *IDISA_NVPTX20_Builder::bitblock_set_bit_impl(Value *pos, const bool safe) {
    Type *const int64ty = getInt64Ty();
    Value *id = CreateCall(tidFunc->getFunctionType(), tidFunc, {});
    Value *id64 = CreateZExt(id, int64ty);
    Value *threadSize = getInt64(groupThreads);
...
std::pair<Value *, Value *> IDISA_NVPTX20_Builder::bitblock_advance_impl(Value *a, Value *shiftin, unsigned shift) {
    Value *id = CreateCall(tidFunc->getFunctionType(), tidFunc, {});
    Value *retVal = CreateCall(mLongAdvanceFunc->getFunctionType(), mLongAdvanceFunc,
                               {id, a, CreateBitCast(getInt64(shift), mBitBlockType), shiftin});
...
std::pair<Value *, Value *> IDISA_NVPTX20_Builder::bitblock_add_with_carry_impl(Value *a, Value *b, Value *carryIn) {
    Value *id = CreateCall(tidFunc->getFunctionType(), tidFunc, {});
...
void IDISA_NVPTX20_Builder::CreateGlobals_impl() {
    Module *const m = getModule();
...
void IDISA_NVPTX20_Builder::CreateBuiltinFunctions_impl() {
...
void IDISA_NVPTX20_Builder::CreateLongAdvanceFunc_impl() {
    Type *const int32ty = getInt32Ty();
    Module *const m = getModule();
    Type *returnType = StructType::get(m->getContext(), {mBitBlockType, mBitBlockType});
    FunctionType *longAdvTy =
        FunctionType::get(returnType, {int32ty, mBitBlockType, mBitBlockType, mBitBlockType}, false);
...
void IDISA_NVPTX20_Builder::CreateLongAddFunc_impl() {
    Type *const int64ty = getInt64Ty();
    Type *const int32ty = getInt32Ty();
    Module *const m = getModule();

    Type *returnType = StructType::get(m->getContext(), {mBitBlockType, mBitBlockType});
    FunctionType *longAddTy =
        FunctionType::get(returnType, {int32ty, mBitBlockType, mBitBlockType, mBitBlockType}, false);
    ...
    Value *carryPtr = CreateGEP(carry, {getInt32(0), id});
    Value *carryInitVal = CreateAnd(CreateOr(gen, CreateAnd(prop, CreateNot(partial_sum))),
                                    CreateBitCast(getInt64(0x8000000000000000), mBitBlockType));
    ...
    Value *rslt = CreateAdd(partial_sum, CreateAnd(CreateLShr(inc, CreateBitCast(id64, mBitBlockType)),
                                                   CreateBitCast(getInt64(1), mBitBlockType)));
...
void IDISA_NVPTX20_Builder::CreateBallotFunc_impl() {
    Type *const int32ty = getInt32Ty();
    Module *const m = getModule();
...
LoadInst *IDISA_NVPTX20_Builder::CreateAtomicLoadAcquire_impl(Value *ptr) { return CreateLoad(ptr); }

StoreInst *IDISA_NVPTX20_Builder::CreateAtomicStoreRelease_impl(Value *val, Value *ptr) {
    return CreateStore(val, ptr);
}

void IDISA_NVPTX20_Builder::CreateBaseFunctions_impl() {
    CreateGlobals();
...
LoadInst *IDISA_NVPTX20_Builder::CreateLoad_impl(Value *Ptr, const char *Name) {
    return IRBuilder<>::CreateLoad(Ptr, Name);
}

LoadInst *IDISA_NVPTX20_Builder::CreateLoad_impl(Value *Ptr, const Twine Name) {
    return IRBuilder<>::CreateLoad(Ptr, Name);
}

LoadInst *IDISA_NVPTX20_Builder::CreateLoad_impl(Type *Ty, Value *Ptr, const Twine Name) {
    return IRBuilder<>::CreateLoad(Ty, Ptr, Name);
}

LoadInst *IDISA_NVPTX20_Builder::CreateLoad_impl(Value *Ptr, bool isVolatile, const Twine Name) {
    return IRBuilder<>::CreateLoad(Ptr, isVolatile, Name);
}

StoreInst *IDISA_NVPTX20_Builder::CreateStore_impl(Value *Val, Value *Ptr, bool isVolatile) {
