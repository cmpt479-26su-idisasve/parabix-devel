...
public:
    ...
    IDISA_SSE_Builder(llvm::LLVMContext & C, const codegen::FeatureSet & featureSet, unsigned bitBlockWidth, unsigned laneWidth)
...
public:
    static constexpr unsigned NativeBitBlockWidth = SSE_width;
    IDISA_SSE2_Builder(llvm::LLVMContext & C, const codegen::FeatureSet & featureSet, unsigned bitBlockWidth, unsigned laneWidth)
    : IDISA_Builder(C, featureSet, SSE_width, bitBlockWidth, laneWidth)
...
public:
    static constexpr unsigned NativeBitBlockWidth = SSE_width;
    IDISA_SSSE3_Builder(llvm::LLVMContext & C, const codegen::FeatureSet & featureSet, unsigned bitBlockWidth, unsigned laneWidth)
    : IDISA_Builder(C, featureSet, SSE_width, bitBlockWidth, laneWidth)
